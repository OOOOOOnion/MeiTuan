...
<body>
		...
		<div id ="top-address">
			<div id="top-center">
				...
				<%  if(session.getAttribute("uname")!=null){ %>
						欢迎：<a href="${pageContext.request.contextPath}/uinfo/uinfo.jsp"><%=session.getAttribute("uname") %></a>
	...
	<iframe src="menu.html"   style="height:800px;width:100%;border-width: 0px;">>
